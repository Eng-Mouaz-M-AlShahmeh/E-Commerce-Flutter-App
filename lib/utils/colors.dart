...
class AppColors {
  ...
  // ignore: non_constant_identifier_names
  static final MaterialColor ORANGE = _factoryColor(0xffe36e00);

  // ignore: non_constant_identifier_names
  static final MaterialColor RED = _factoryColor(0xffeb2832);

  // ignore: non_constant_identifier_names
  static final MaterialColor LIGHT_ORANGE = _factoryColor(0xffff9736);
